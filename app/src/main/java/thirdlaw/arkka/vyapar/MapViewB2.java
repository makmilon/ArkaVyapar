...
public class MapViewB2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_b2);
        ...
        nearRecview=findViewById(R.id.search_list_recViewB2);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_users2.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
