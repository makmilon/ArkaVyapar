...
public class MapViewB5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_b5);
        ...
        nearRecview=findViewById(R.id.search_list_recViewB5);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_users5.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
