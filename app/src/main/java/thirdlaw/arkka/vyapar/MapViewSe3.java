...
public class MapViewSe3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_se3);
        ...
        nearRecview=findViewById(R.id.search_list_recView3);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_user3.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
