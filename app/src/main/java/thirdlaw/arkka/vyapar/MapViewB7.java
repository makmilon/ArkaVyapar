...
public class MapViewB7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_b7);
        ...
        nearRecview=findViewById(R.id.search_list_recViewB7);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_users7.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
