...
public class MapViewSe7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_se7);
        ...
        nearRecview=findViewById(R.id.search_list_recView7);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_user7.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
