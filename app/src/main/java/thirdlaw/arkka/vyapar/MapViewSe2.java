...
public class MapViewSe2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_se2);
        ...
        nearRecview=findViewById(R.id.search_list_recView1);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_user2.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
