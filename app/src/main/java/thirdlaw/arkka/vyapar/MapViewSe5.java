...
public class MapViewSe5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_se5);
        ...
        nearRecview=findViewById(R.id.search_list_recView5);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_user5.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
