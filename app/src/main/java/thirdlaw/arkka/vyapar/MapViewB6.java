...
public class MapViewB6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_view_b6);
        ...
        nearRecview=findViewById(R.id.search_list_recViewB6);
        nearRecview.setLayoutManager(new LinearLayoutManager(getApplicationContext()));

        String productUrl="http://14.139.158.99/arkvyaper/api/longlat_users6.php?uid="+user_id+"&longi="+ulong+"&lati="+ulat;
